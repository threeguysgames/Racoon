...
namespace GameEngineTest
{
    public class AI
    {
        ...
        protected bool enemiesExist = false;
        ...
        public virtual void Update(Character[] c, int Id, Map map)
        {
            ...
            if (me.useSlowTime)
                ...
                jobFrame -= Game1.realTime;

            if (!enemiesExist)
                job = AI_JOB.JOB_FOLLOW;
        ...
        protected void DoJob(Character[] c, int Id)
        {
            switch (job)
            {
                ...
                case AI_JOB.JOB_FOLLOW:

                    targID = 0;
                    FaceTarg(c);
                    ChaseTarg(c, 150f, 20f);
                    
                    break;

                case AI_JOB.JOB_MELEE_CHASE:
                    
                    if (targID > -1 && c[targID] != null)
                    {
                        FaceTarg(c);
